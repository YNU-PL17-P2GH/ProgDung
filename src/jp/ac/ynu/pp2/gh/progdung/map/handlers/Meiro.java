...
public class Meiro extends MapHandlerBase {

	public Meiro(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("meiro", player_x, player_y, player_d, play);
	}
