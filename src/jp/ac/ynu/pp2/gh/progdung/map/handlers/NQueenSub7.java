...
public class NQueenSub7 extends MapHandlerBase {
	public NQueenSub7(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub7", player_x, player_y, player_d, play);
	}
