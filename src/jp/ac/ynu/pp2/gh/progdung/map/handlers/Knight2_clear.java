...
public class Knight2_clear extends MapHandlerBase {

	private MapClearObject pc;

	public Knight2_clear(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("knight2_clear", player_x, player_y, player_d, play);
	}
