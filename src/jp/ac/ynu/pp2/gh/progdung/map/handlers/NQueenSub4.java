...
public class NQueenSub4 extends MapHandlerBase {
	public NQueenSub4(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub4", player_x, player_y, player_d, play);
	}
