...
public class NQueenSub8 extends MapHandlerBase {
	public NQueenSub8(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub8", player_x, player_y, player_d, play);
	}
