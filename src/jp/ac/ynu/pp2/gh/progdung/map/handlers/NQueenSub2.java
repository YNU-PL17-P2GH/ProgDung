...
public class NQueenSub2 extends MapHandlerBase {
	public NQueenSub2(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub2", player_x, player_y, player_d, play);
	}
