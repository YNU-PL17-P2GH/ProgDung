...
public class NQueenSub9 extends MapHandlerBase {
	public NQueenSub9(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub9", player_x, player_y, player_d, play);
	}
