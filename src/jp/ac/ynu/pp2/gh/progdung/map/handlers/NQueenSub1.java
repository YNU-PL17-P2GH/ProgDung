...
public class NQueenSub1 extends MapHandlerBase {
	public NQueenSub1(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub1", player_x, player_y, player_d, play);
	}
