...
public class Shortest extends MapHandlerBase {

	public Shortest(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("shortest", player_x, player_y, player_d, play);
	}
