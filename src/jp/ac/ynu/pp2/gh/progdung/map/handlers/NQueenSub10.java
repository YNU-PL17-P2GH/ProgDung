...
public class NQueenSub10 extends MapHandlerBase {
	public NQueenSub10(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub10", player_x, player_y, player_d, play);
	}
