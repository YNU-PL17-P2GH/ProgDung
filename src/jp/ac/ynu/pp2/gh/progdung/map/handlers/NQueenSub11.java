...
public class NQueenSub11 extends MapHandlerBase {
	public NQueenSub11(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub11", player_x, player_y, player_d, play);
	}
