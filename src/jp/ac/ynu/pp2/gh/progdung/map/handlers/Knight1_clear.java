...
public class Knight1_clear  extends MapHandlerBase {

	public Knight1_clear(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("knight1_clear", player_x, player_y, player_d, play);
	}
