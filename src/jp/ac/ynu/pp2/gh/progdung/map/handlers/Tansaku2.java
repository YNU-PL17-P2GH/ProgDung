...
public class Tansaku2 extends MapHandlerBase {

	public Tansaku2(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("tansaku2", player_x, player_y, player_d, play);
	}
