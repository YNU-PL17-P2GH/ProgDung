...
public class Sort2_fall extends MapHandlerBase{

	public Sort2_fall(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("sort2_fall", player_x, player_y, player_d, play);
	}
