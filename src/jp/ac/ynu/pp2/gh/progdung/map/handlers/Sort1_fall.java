...
public class Sort1_fall extends MapHandlerBase {

	public Sort1_fall(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("sort1_fall", player_x, player_y, player_d, play);
	}
