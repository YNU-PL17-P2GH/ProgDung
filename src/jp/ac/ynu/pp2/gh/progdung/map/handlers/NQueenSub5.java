...
public class NQueenSub5 extends MapHandlerBase {
	public NQueenSub5(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub5", player_x, player_y, player_d, play);
	}
