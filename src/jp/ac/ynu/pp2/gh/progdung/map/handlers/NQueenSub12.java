...
public class NQueenSub12 extends MapHandlerBase {
	public NQueenSub12(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub12", player_x, player_y, player_d, play);
	}
