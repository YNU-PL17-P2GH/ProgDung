...
public class NQueenSub3 extends MapHandlerBase {
	public NQueenSub3(int player_x, int player_y, DIRECTION player_d, DungeonPlay play) {
		super("nqueensub3", player_x, player_y, player_d, play);
	}
